...
#  ├─┤│  │├─┤└─┐
#  ┴ ┴┴─┘┴┴ ┴└─┘
alias mirrors="sudo reflector --verbose --latest 5 --country 'Indonesia' --age 5 --sort rate --save /etc/pacman.d/mirrorlist"
...
alias yta-mp3="yt-dlp --extract-audio --audio-format mp3 --audio-quality 320k "
